      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
          ...
          <div className="shrink-0 flex flex-col items-center gap-4">
            <div className="relative w-56 h-56 sm:w-64 sm:h-64 lg:w-72 lg:h-72 rounded-full overflow-hidden border-4 border-primary/30 shadow-2xl shadow-primary/20 ring-1 ring-border">
              <Image
          ...
          <div className="flex-1 text-center lg:text-left">
            ...
            <p className="text-lg text-muted-foreground max-w-xl mb-10 leading-relaxed text-pretty">
              I am a Computer Engineering student with a minor in UI/UX Design.
              I work at the intersection of full-stack development, deployment
